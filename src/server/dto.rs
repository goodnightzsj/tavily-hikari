...
struct ApiKeyView {
    ...
    effective_quota_remaining: Option<i64>,
    runtime_rpm_limit: Option<i64>,
    runtime_rpm_used: Option<i64>,
    runtime_rpm_remaining: Option<i64>,
    cooldown_until: Option<i64>,
    budget_block_reason: Option<String>,
