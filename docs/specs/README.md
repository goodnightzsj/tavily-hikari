...
| 45squ | 账户级配额迁移与登录后用户控制台                       | 已完成（快车道） | `45squ-account-quota-user-console/SPEC.md`            | 2026-03-06 | MCP probe contract fix: dual Accept + SSE parse + quota-blocked UX on `/console#/tokens/:id`     |
