...
| grzw4 | Web 前端 shadcn/ui 主通路收敛整改                      | 进行中（本地验证完成） | `grzw4-web-shadcn-mainline-convergence/SPEC.md`            | 2026-03-09 | wrappers + P0/P1 迁移完成；build/storybook/browser smoke 已通过；待快车道 PR/checks 收敛                           |
