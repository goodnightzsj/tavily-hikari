...
| 9b9w5 | Bun runtime 强制化与 Node 痕迹收口                     | 部分完成（5/6）   | `9b9w5-bun-runtime-enforcement/SPEC.md`                    | 2026-03-09 | runtime enforcement + no-node proof + browser smoke complete; PR/review-loop pending                               |
...
| 45squ | 账户级配额迁移与登录后用户控制台                       | 已完成（快车道）  | `45squ-account-quota-user-console/SPEC.md`                 | 2026-03-09 | follow-up: token detail probe bubble now uses theme-safe popover surfaces with fresh dark/light Storybook evidence |
...
| grzw4 | Web 前端 shadcn/ui 主通路收敛整改                      | 进行中（PR #110） | `grzw4-web-shadcn-mainline-convergence/SPEC.md`            | 2026-03-09 | wrappers + admin components stories 已整理分组；PR #110 持续收敛中                                                 |
