...
| 7hs2d | UserConsole Storybook 验收参数重构                     | 部分完成（4/5）  | `7hs2d-user-console-storybook-acceptance-controls/SPEC.md` | 2026-03-07 | bun test + build + storybook build passed; acceptance controls renamed with business semantics              |
