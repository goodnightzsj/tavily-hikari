...
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------- |
| mx657 | 管理员控制台返回用户控制台入口                         | 部分完成（4/5）  | `mx657-admin-return-user-console-entry/SPEC.md`            | 2026-03-09 | PR #108；checks green；visual evidence added；`codex review` blocked on repeated 502 retries, so M5 remains pending |
