...
- The prepare phase no longer queries PR metadata; it always treats each eligible `main` commit as a stable patch release, then computes the next tag idempotently. Source: `.github/workflows/release.yml:29`, `.github/workflows/release.yml:56`, `.github/workflows/release.yml:65`.
